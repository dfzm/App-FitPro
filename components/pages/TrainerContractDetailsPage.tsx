...
interface TrainerContractDetailsPageProps {
  bookingId: string;
}

export function TrainerContractDetailsPage({ bookingId }: TrainerContractDetailsPageProps) {
  const { user } = useAuth();
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="text-gray-600">ID: {booking.clientId}</div>
                </div>
                <div>
                  <div className="text-sm font-semibold text-gray-500 uppercase mb-2">Entrenador</div>
                  <div className="font-bold text-lg">{user?.name || booking.trainerName}</div>
